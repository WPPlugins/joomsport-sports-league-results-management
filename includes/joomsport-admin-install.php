...
class JoomSportAdminInstall {
	...
	add_action( "load-$hook", function(){ $obj = JoomSportBoxField_Plugin::get_instance();$obj->screen_option();}  );
        ...
        add_submenu_page( 'options.php', __( 'Player statistic New', 'joomsport-sports-league-results-management' ), __( 'Player statistic New', 'joomsport-sports-league-results-management' ), 'manage_options', 'joomsport-boxfields-form', array('JoomSportBoxFieldsNew_Plugin', 'view'));
    ...
    public static function joomsport_fe_wp_head(){
        ...
        $jsArray = array("joomsport_season","joomsport_match","joomsport_team","joomsport_match","joomsport_player","joomsport_venue");
