        ...
        <table class="table table-striped jsTblEvnts"  cellspacing="0" cellpadding="0">
            ...
            if (isset($pevents) && $pevents) {
                foreach ($pevents as $m_events) {
                    ...
                    echo '<td><input type="number" class="jsNumberNotNegative" style="width:50px;" size="5" maxlength="5" name="e_minuteval[]" value="'.$m_events->minutes.'" step="1" min="0" /></td>';
                    echo '<td><input type="number" class="jsNumberNotNegative" style="width:50px;" size="5" maxlength="5" name="e_countval[]" value="'.$m_events->ecount.'" step="1" min="0" /></td>';
            ...
            <tfoot>
                <tr>
                    ...
                    <td class="title" width="60">
                            <input name="e_minutes" style="width:50px;" id="e_minutes" class="jsNumberNotNegative" type="number" maxlength="5" size="5" step="1" min="0"/>
                    </td>

                    <td class="title" width="60">
                            <input name="re_count" style="width:50px;" id="re_count" class="jsNumberNotNegative" type="number" maxlength="5" size="5" value="1" step="1" min="0" />
