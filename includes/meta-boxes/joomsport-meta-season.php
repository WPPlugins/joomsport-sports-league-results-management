                    ...
                    <td align="right">
                        <div class="controls">
                            <fieldset class="radio btn-group">
                                <?php echo JoomSportHelperSelectBox::Radio('standings[emblem_chk]', $is_field,isset($metadata['emblem_chk'])?$metadata['emblem_chk']:0,'');?>
                            </fieldset>
                        </div>
                ...
                <td id="app_newcol">
                    ...
                    if(count($metadata) && $metadata){
                        ...
                        <div class="jscolordivcont">
                            ...
                            <input class="button" type="button" style="cursor:pointer;" onclick="showColorGrid2('input_field_<?php echo $ch;?>','sample_<?php echo $ch;?>');" value="...">&nbsp;<input type="text"  style="width:100px;" ID="input_field_<?php echo $ch;?>" class="jscolorinp" name="color_field[]" size="9" value="<?php echo $metadata[$intA]['color_field'];?>"><input type="text" ID="sample_<?php echo $ch;?>"  style="width:30px;" size="1" value="" class="color-kind" style="width:30px; background-color: <?php echo $metadata[$intA]['color_field'];?>"/>
