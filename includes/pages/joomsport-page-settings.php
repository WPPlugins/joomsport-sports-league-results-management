    ...
    public static function action(){
        ...
        if (isset($_REQUEST['nonce']) && wp_verify_nonce($_REQUEST['nonce'], basename(__FILE__))) {
            ...
            */
            ...
            $layouts = array_map( 'sanitize_text_field', wp_unslash( $layouts ) );
        ...
        if(count($adf)){
            $alltmp[__('Additional fields','joomsport-sports-league-results-management')] = $adf;
        }
        ...
        if(count($adf_se)){
            $alltmp_se[__('Additional fields','joomsport-sports-league-results-management')] = $adf_se;
        }
                ...
                <div class="jsrespdiv6">
                    <div class="jsBepanel">
                        ...
                        <div class="jsBEsettings">
                            ...
                            <h4>
                                <?php echo __('Players tab settings', 'joomsport-sports-league-results-management');?>
                            </h4>
                            <table class="adminlistsNoBorder">
                                <tr>
                                    <td width="250">
                                ...
                                <tr>
                                        <td><?php echo __('Order players by (including player extra fields, player events)', 'joomsport-sports-league-results-management');?></td>
                                        <td>
                                ...
                                <tr>
                                    <td width="250">
                                        <?php echo __('Show in player tab', 'joomsport-sports-league-results-management');?>
                                    </td>
                                    <td>
                                        <?php
                                        echo JoomSportHelperSelectBox::Simple('layouts[set_teampgplayertab]', $is_field_pltab,$jsconfig->get('set_teampgplayertab'),'',false);
                                        ?>
                    ...
                    <div class="jsBepanel">
                        ...
                        <div class="jsBEsettings">
                            <table class="adminlistsNoBorder">
                                <tr>
                                    <td width="250">
                                        <?php echo __('Player extra field (select box type) for ordering in squad tab', 'joomsport-sports-league-results-management');?>
                                    </td>
                                    <td>
