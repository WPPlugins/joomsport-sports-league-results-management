...
class classJsportPagination
{
    ...
    {
        $kl = '<div class="display col-xs-12 col-sm-12 col-md-4 col-lg-4 text-right" style="min-width: 170px; float: right;"><label>'.__('Display','joomsport-sports-league-results-management').'</label>';
