...
class classJsportPlayer
{
    ...
    public function getEvents()
    {
        ...
        $players = classJsportgetplayers::getPlayersFromTeam(array('season_id' => $this->season_id), $this->id);
            ...
            if(isset($this->lists['players'])){
                for($intA=0;$intA<count($this->lists['players']);$intA++){
                    ...
                    if($pl->team_id){
                        ...
                        $teamObj = new classJsportTeam($pl->team_id);
    ...
    public function getMatchesBlock(){
        ...
        $query = 'SELECT s.*,p.post_id'
            ...
            .' WHERE 1=1'
            . ($this->season_id?' AND s.season_id='.$this->season_id:'')
            .' AND s.squad_type != 0 '    
